...
const interestRouter = require('./src/routers/interests_router')
const profileRouter = require('./src/routers/profile_router')
const aiRouter = require('./src/routers/ai_router')
